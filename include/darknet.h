...
struct layer{
    ...
    float * output;
    float * loss;
    float * loss_temp; //nithi code
    float * loss_temp1; //nithi code
    float * squared;
    float * norms;
    ...
    float * output_gpu;
    float * loss_gpu;
    float * loss_gpu_temp; // nithi code
    float * loss_gpu_temp1; // nithi code
    float * delta_gpu;
    float * rand_gpu;
    float * squared_gpu;
    float * norms_gpu;
...
network *parse_network_cfg_unet(char *filename, network * net);
